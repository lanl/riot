...
file_id = "steady_radiation_shock"
gold_id = "steady_radiation_shock"
amr = True
sparse = True
nranks = 1
...
def run(**kwargs):
    ...
    riot.generate("radiation_diffusion/steady_radiation_shock.py")
    ...
    riot.mpirun(nranks, "radiation_diffusion/steady_radiation_shock.rin", args)
